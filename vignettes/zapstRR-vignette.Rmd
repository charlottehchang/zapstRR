...
Contrast this $\beta_{age}$ against the one generated above for the univariate barbet logistic regression, which failed to even return a standard error: `RRunivariate(y=huntRRdata['Barbet'], x=huntRRdata['Age'], p00=p00, p11=p11)$estimates[2,]`.
